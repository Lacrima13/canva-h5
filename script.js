...
function renderResult() {
  ...
  document.getElementById("posterTitle").textContent = smartTitle;
  document.getElementById("posterSubtitle").textContent = smartSubtitle;
  document.getElementById("posterTag").textContent = smartTag;
...
作品的交互路径包括：开场代入、痛点洞察、身份选择、任务选择、风格测试、AI生成模拟、结果展示和最终转化。视觉风格采用清爽、年轻、轻科技感的移动端界面语言，突出Canva可画“低门槛、高效率、强模板、可编辑、易导出”的品牌价值。
